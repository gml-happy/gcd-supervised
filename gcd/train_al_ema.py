...
if __name__ == "__main__":
    ...
    #args.base_exp_id = "/home/pod/program/shared-vme/ActiveGCD-main/dev_outputs_base/aircraft/aircraft_simgcd_(15.08.2024___53.346)/checkpoints/model.pt"
    ...
    backbone_ema = torch.hub.load('facebookresearch/dinov2', 'dinov2_vitl14')

    # backbone = torch.hub.load('facebookresearch/dinov2', 'dinov2_vitb14')
    # backbone_ema = torch.hub.load('facebookresearch/dinov2', 'dinov2_vitb14')

    # NOTE: Hardcoded image size as we do not finetune the entire ViT model   224
    args.image_size = 308
    args.feat_dim = 1024
    ...
    if args.base_ckpts_date is not None:
        if args.base_exp_id is not None:
           ...
           #args.base_model_dir = "/home/pod/program/shared-vme/ActiveGCD-main/dev_outputs_base/aircraft/aircraft_simgcd_(15.08.2024___53.346)/checkpoints/model.pt"
            args.base_model_dir = "/home/pod/program/shared-vme/ActiveGCD-main/dev_outputs_al_ema_6rounds/aircraft/old50_ratio0.5_20240815-175811_query100/NovelMarginSamplingAdaptive_exp1/checkpoints/model_ema_round6.pt"
        else:
